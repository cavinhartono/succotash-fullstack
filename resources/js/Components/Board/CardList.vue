...
import CreateBoardList from "@/Components/Board/CardListItemForm.vue";
import { ref } from "vue";
...
<template>
            ...
            <Menu as="div" class="relative z-10">
                ...
                >
                    <div class="flex justify-center items-center gap-1">
                        <span class="w-1 h-1 bg-black-700 rounded-full"></span>
                        <span class="w-1 h-1 bg-black-700 rounded-full"></span>
                        <span class="w-1 h-1 bg-black-700 rounded-full"></span>
                    </div>
                </MenuButton>
    ...
    <div class="px-3 mt-3">
        <CardListItemForm :list="list" @created="onCardCreated()" />
    </div>
</template>
